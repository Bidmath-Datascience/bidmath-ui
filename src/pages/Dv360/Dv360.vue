<template>
  <v-container fluid>
    <div class="tradedesk-page">
      <v-row no-gutters class="d-flex justify-space-between mt-10 mb-6">
        <h1 class="page-title">DV360 Campaigns</h1>
      </v-row>
      <v-row >
        <v-col cols="12">
  ...
  <v-row justify="center">
    ...
    >
      <v-card>
        <v-card-title>
          <span class="text-h5">Add Campaign</span>
        </v-card-title>
  ...
  data() {
    return {
      ...
      adgroup_headers: [
        ...
        { text: 'LINEITEM', value: 'adgroup_id' },
        { text: 'ADVERTISER', value: 'advertiser_id' },
        { text: 'INSERTION ORDER', value: 'campaign_id' },
